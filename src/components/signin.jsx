...
class Signin extends Component {
  ...
  handleLogin = (response) =>{
	if(response.success){
		...
		this.props.storeToken(response.success.token)
							...
							<h3 class="account__title">Login</h3>
								<div class="account__form">
									<div class="input__box">
										...
										<input type="email" value={this.state.login_email} onChange={(e) => this.setState({login_email: e.target.value})} />
									</div>
									<div class="input__box">
										<label>Password<span>*</span></label>
										<input type="password" value={this.state.login_password} onChange={(e) => this.setState({login_password: e.target.value})}/>
									</div>
									<span cla="mb-2" style={{color: 'red'}}>{this.state.login_error != null ? this.state.login_error : null}</span>
									<div class="form__btn">
										<button onClick={() => this.login()}>Login</button>
										<label class="label-for-checkbox">
											<input id="rememberme" class="input-checkbox mr-2" name="rememberme" value="forever" type="checkbox"/>
							...
							<form action="#">
								<div class="account__form">
                                    <div class="input__box">
										...
										<input type="name" value={this.state.reg_fullname} onChange={(e) => this.setState({reg_fullname: e.target.value})}/>
									</div>
									<div class="input__box">
										<label>Email address <span>*</span></label>
										<input type="email" value={this.state.reg_email} onChange={(e) => this.setState({reg_email: e.target.value})}/>
									</div>
									<div class="input__box">
										<label>Phone number<span>*</span></label>
										<input type="name" value={this.state.phone_no} onChange={(e) => this.setState({phone_no: e.target.value})}/>
									</div>
									<div class="input__box">
										<label>Password<span>*</span></label>
										<input type="password" value={this.state.reg_pass} onChange={(e) => this.setState({reg_pass: e.target.value})}/>
									</div>
									<div class="input__box">
										<label>Confirm password<span>*</span></label>
										<input type="password" value={this.state.c_password} onChange={(e) => this.setState({c_password: e.target.value})}/>
									</div>
									<span cla="mb-2" style={{color: 'red'}}>{this.state.reg_error != null ? this.state.reg_error : null}</span>
									<div class="form__btn">
