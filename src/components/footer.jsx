  ...
  render() {
    return (
      ...
      <div class="container text-center text-md-left mt-3">
          ...
          >
            <div class="col-md-3 col-lg-4 col-xl-3 mb-4" style={{borderRight: '4px solid black'}}>
              ...
              <div style={{ width: "20%" }}>
                  ...
                  class="ml-2"
                    ...
                    style={{ height: 35, width: 35, position: 'relative', right: 10}}
                  />
                </div>
                <div style={{ width: "80%" }}>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4" style={{borderRight: '4px solid black'}}>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" style={{borderRight: '4px solid black'}}>
      ...
      <div class="container mt-3">
        <div class="row" style={{background: '#F1F2EE', height: 120, borderRadius: 12}}>
              <div class="col">
      ...
      <div class="row d-flex justify-content-center align-items-center pt-4 pb-4">
        <p style={{fontSize: 18}}><span class="font-weight-bold">গ্রন্থিক.কম বাংলাদেশের অনলাইন ভিত্তিক বুক শপগুলোর মধ্যে অন্যতম । </span>বইয়ের এক ভিন্নধর্মী প্লাটফর্ম গড়ে তুলতে আমাদের এই যাত্রা। </p>
        <p>দেশের সকল প্রান্তের পাঠকের কাছে সবচেয়ে সহজ, নিরাপদ ও দ্রুত বই পৌছে দেবার লক্ষ্য নিয়ে আমরা আমাদের পথচলা শুরু করছি ।</p>
        <p>পাঠকের জন্য নানারকম সৃজনশীল ও সময়োপযোগী আয়োজনের মাধ্যমে সহসাই আমরা দেশের</p>
        <p>সকল প্রান্তে নিজেদের অবস্থান তৈরী করে নিতে পারবো বলে আশা করছি । </p>
      </div>
      </div>
      <div class="container">
      <div class="footer-copyright text-center text-black-50 py-3" style={{background: '#C67935'}}>
          gronthik.com
          <a
